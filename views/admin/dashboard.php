...
<head>
    ...
    <link rel="stylesheet" href="public/css/main.css?kkf">
                ...
                <form class="my-5 hide" name="addUserForm" id="addUserForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="addcin" placeholder="carte d'identité number"
                                name="addcin" />
                            <div class="is-invalid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="addemail" placeholder="email" name="addemail" />
                        <div class="is-invalid">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="addgrade" placeholder="grade" name="addgrade" />
                            <div class="is-invalid">
                    ...
                    <button class="btn btn-success" name="submituser" id="submitadduser" onclick="addUsers(event)">Add
                        User</button>
                </form>
            </div>
            <!-- end add user form -->
